import { BaseOptionException } from './erreur';
...
interface Err<K extends BaseOptionException<unknown>>
  extends OptionBase<null, K> {
  error: K;
}
...
export const Err = function <K extends BaseOptionException<unknown>>(
  error: K,
): Option<null, K> {
  return {
    error,
